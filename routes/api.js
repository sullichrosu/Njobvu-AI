...
api.post("/mapKwCocoCsv", asyncHandler(mapKwCocoCsv));
...
api.post("/toggleAllReview", asyncHandler(toggleAllReview));
api.post("/api/projects/toggleAllReview", asyncHandler(toggleAllReview));

...
async function getYolo3SettingsPage(req, res) {
    ...
    try {
        ...
        global.logger.error("Error fetching projects for yolo3 settings page:", err);
    }
    ...
    if (!fs.existsSync(trainingPath)) {
        ...
        fs.mkdirSync(weightsPath, { recursive: true });
    } else if (!fs.existsSync(darknetPathFile)) {
        fs.writeFileSync(darknetPathFile, "");
    }
    ...
    const defaultPath = (global.configFile && global.configFile.default_darknet_path) || null;
